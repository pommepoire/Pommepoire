      ...
      <SwipeSheet onClose={onClose} C={C}>
        <div style={{padding:"14px 18px 0",position:"sticky",top:0,background:C.bg,zIndex:1}}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
            <div style={{fontSize:16,fontWeight:700,color:C.text}}>Voyageurs</div>
            <button onClick={onClose} style={{padding:"6px 16px",border:`1.5px solid ${C.border}`,borderRadius:20,background:"none",color:C.text,fontSize:13,fontWeight:600,cursor:"pointer"}}>Fermer</button>
          </div>
        </div>
    ...
    <div style={ov} onClick={e=>e.target===e.currentTarget&&onClose()}>
      <SwipeSheet onClose={onClose} C={C}>
        <div style={{padding:"14px 18px 0",position:"sticky",top:0,background:C.bg,zIndex:1}}>
          <div style={{width:36,height:4,background:"#ccc",borderRadius:99,margin:"0 auto 10px"}}></div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
            <div style={{fontSize:16,fontWeight:700,color:C.text}}>Activité récente</div>
            <button onClick={onClose} style={{padding:"6px 16px",border:`1.5px solid ${C.border}`,borderRadius:20,background:"none",color:C.text,fontSize:13,fontWeight:600,cursor:"pointer"}}>Fermer</button>
          </div>
        </div>
        <div style={{padding:"0 18px 28px"}}>
